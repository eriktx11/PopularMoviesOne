...
import com.example.android.popularmoviesone.data.*;
...
public class DataBaseHelperTest extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_MOVIE_EXTRAS_TABLE = "CREATE TABLE " + TheMovieExtras.TABLE_NAME + " (" +
        ...
        final String SQL_CREATE_MOVIE_LIST_TABLE = "CREATE TABLE " + TheMovieList.TABLE_NAME + " (" +
